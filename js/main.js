(()=>{
    var e = {
        732: ()=>{
            document.addEventListener("DOMContentLoaded", (()=>{
                const e = document.getElementById("burgerBtn")
                  , t = document.getElementById("js-header")
                  , s = document.getElementById("js-body")
                  , i = document.querySelectorAll(".nav__link");
                e.addEventListener("click", (()=>{
                    t.classList.toggle("open-burger"),
                    s.classList.toggle("stop-scroll")
                }
                )),
                i.forEach((e=>{
                    e.addEventListener("click", (()=>{
                        t.classList.remove("open-burger"),
    ...
    (()=>{
        ...
        console.log((()=>{
            ...
            return /android/i.test(t) ? (e.htmlEl.classList.add("page--android"),
            "Android") : /iPad|iPhone|iPod/.test(t) && !window.MSStream ? (e.htmlEl.classList.add("page--ios"),
            "iOS") : "unknown"
        }
        )());
        const n = {
            ...
            for (let n = 1; n < e.length; n += 1) {
                ...
                !("undefined" != typeof window && void 0 !== window.HTMLElement ? i instanceof HTMLElement : i && (1 === i.nodeType || 11 === i.nodeType)))) {
                    ...
                    for (let s = 0, i = e.length; s < i; s += 1) {
                        ...
                        void 0 !== n && n.enumerable && (w(t[i]) && w(r[i]) ? r[i].__swiper__ ? t[i] = r[i] : b(t[i], r[i]) : !w(t[i]) && w(r[i]) ? (t[i] = {},
                        r[i].__swiper__ ? t[i] = r[i] : b(t[i], r[i])) : t[i] = r[i])
                    }
                }
            }
            var i;
        ...
        const M = {
          ...
          , L = {
            ...
            updateSlides: function() {
                ...
                i.centeredSlides && i.cssMode && (C(e.wrapperEl, "--swiper-centered-offset-before", ""),
                ...
                for (let n = 0; n < p; n += 1) {
                    ...
                    "none" !== a.css("display")) {
                        ...
                        f.push(x),
                        i.centeredSlides ? (T = T + x / 2 + E / 2 + b,
                        0 === E && 0 !== n && (T = T - r / 2 - b),
                        0 === n && (T = T - r / 2 - b),
                        Math.abs(T) < .001 && (T = 0),
                ...
                i.centeredSlides && i.cssMode && !i.centeredSlidesBounds) {
                    ...
                    C(e.wrapperEl, "--swiper-centered-offset-after", e.size / 2 - f[f.length - 1] / 2 + "px");
        ...
        function O(e) {
            ...
            if (a.noSwiping && (h ? function(e, t=this) {
                return function t(s) {
                    return s && s !== r() && s !== l() ? (s.assignedSlot && (s = s.assignedSlot),
                    s.closest(e) || t(s.getRootNode().host)) : null
                }(t)
            }(u, c.target) : p.closest(u)[0]))
                return void (t.allowClick = !0);
            if (a.swipeHandler && !p.closest(a.swipeHandler)[0])
                return;
        ...
        const B = (e,t)=>{
            const s = r()
              , {params: i, touchEvents: n, el: a, wrapperEl: l, device: o, support: d} = e
              , c = !!i.nested
            ...
            if (d.touch) {
                ...
                a[p](n.move, e.onTouchMove, d.passiveListener ? {
                    passive: !1,
                    capture: c
                } : c),
            ...
            i.updateOnWindowResize ? e[u](o.ios || o.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", I, !0) : e[u]("observerUpdate", I, !0)
        }
          , j = {
        ...
        const R = {
            ...
            images: {
                loadImage: function(e, t, s, i, n, r) {
                    ...
                    m(e).parent("picture")[0] || e.complete && n ? d() : t ? (o = new a.Image,
                    o.onload = d,
                    o.onerror = d,
                    i && (o.sizes = i),
                    s && (o.srcset = s),
                ...
                i.device = function(e={}) {
                    return S || (S = function({userAgent: e}={}) {
                        ...
                        const p = n.match(/(iPod)(.*OS\s([\d_]+))?/)
                          ...
                          , h = "Win32" === i;
                        let f = "MacIntel" === i;
                        return !c && f && t.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${a}x${o}`) >= 0 && (c = n.match(/(Version)\/([\d.]+)/),
                        c || (c = [0, 1, "13_0_0"]),
                        f = !1),
                        d && !h && (r.os = "android",
                        r.android = !0),
        ...
        X.use([function({swiper: e, on: t, emit: s}) {
            ...
            t("init", (()=>{
                ...
                n.observe(e.el)) : (i.addEventListener("resize", r),
        ...
        Y.use([function({swiper: e, extendParams: t, on: s, emit: i}) {
            function n(t) {
                let s;
                return t && (s = m(t),
        ...
        , function({swiper: e, extendParams: t, on: s, emit: i}) {
            ...
            function d() {
                ...
                if ("fraction" === s.type && (d.find(K(s.currentClass)).text(s.formatFractionCurrent(c + 1)),
                ...
                "progressbar" === s.type) {
                    ...
                    d.find(K(s.progressbarFillClass)).transform(`translate3d(0,0,0) scaleX(${n}) scaleY(${r})`).transition(e.params.speed)
                }
            ...
            function c() {
                ...
                if ("bullets" === t.type) {
                    ...
                    n.html(r),
                    e.pagination.bullets = n.find(K(t.bulletClass))
                }
            ...
            function p() {
                ...
                s.length > 1 && (s = s.filter((t=>m(t).parents(".swiper")[0] === e.el)))),
                ...
                t.clickable && s.on("click", K(t.bulletClass), (function(t) {
                    t.preventDefault();
        ...
        new Y(".hero-swiper",{
            slidesPerView: 1,
            navigation: {
                nextEl: ".testimonial-swiper__btn-next",
                prevEl: ".testimonial-swiper__btn-prev"
            },
            pagination: {
                el: ".hero__pag",
                clickable: !0
